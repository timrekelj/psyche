...
export default function ReflectionDetailScreen() {
    ...
    return (
        <View className="flex-1 bg-white px-8 py-16">
            ...
            >
                <View className="mb-6">
                    <Text className="mb-4 text-center font-instrument-serif text-2xl">
                        {emotionLabels[entry.emotions] || entry.emotions}
                    </Text>

                    <View className="mb-6 items-center p-4 text-center">
                        <Text className="font-instrument-serif text-lg">
                            {emotionLabels[entry.emotions] || entry.emotions}
                        </Text>
                        <Text className="font-instrument-serif-italic text-lg">
                            brought me here{' '}
                            {formatRelativeDate(entry.cried_at).toLowerCase()}
                        </Text>
                    </View>

                    <Text className="mb-6 text-center font-instrument-serif text-base">
                        This feeling was rated {entry.feeling_intensity}/10
                    </Text>

                    <View className="mb-6">
                        <Text className="mb-2 font-instrument-serif-italic text-base">
